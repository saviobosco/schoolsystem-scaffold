...
/**
 * StudentLoginsFixture
 *
 */
class StudentLoginsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'last_seen' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'status' => ['type' => 'tinyinteger', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'student_id' => 1,
            'last_seen' => 1575730763,
            'status' => 1,
            'created_at' => 1575730763,
            'updated_at' => 1575730763
        ],
    ];
}
