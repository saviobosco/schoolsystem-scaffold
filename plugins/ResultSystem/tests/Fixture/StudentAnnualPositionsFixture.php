...
/**
 * StudentAnnualPositionsFixture
 *
 */
class StudentAnnualPositionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'total' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'average' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
