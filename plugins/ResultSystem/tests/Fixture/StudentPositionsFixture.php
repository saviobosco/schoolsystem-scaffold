...
/**
 * StudentPositionsFixture
 *
 */
class StudentPositionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'grade' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'student_id' => ['type' => 'index', 'columns' => ['student_id', 'session_id', 'class_id', 'term_id'], 'length' => []],
        ],
        '_constraints' => [
