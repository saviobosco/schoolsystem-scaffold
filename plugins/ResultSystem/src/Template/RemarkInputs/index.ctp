    ...
    <div class="col-sm-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title"> Remark Inputs </h4>
            </div>
            <div class="panel-body">
                <div>
                    <?php if(!$remarkInputs->isEmpty()) : ?>
                        <table class="table">
                            <thead>
                            <tr>
                                <th> Main Value</th>
                            ...
                            <tbody>
                            <?php foreach($remarkInputs as $input) : ?>
                                <tr>
                ...
                <?= $this->Form->create(null, ['url' => ['_name' => 'remark-inputs:store'], 'type' => 'POST']) ?>
                <div class="row">
                    <div class="col-sm-2">
