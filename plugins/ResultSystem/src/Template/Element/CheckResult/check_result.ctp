        ...
        return {
            handleStudentId: function() {
                ...
                document.querySelector("#admission_number").addEventListener("blur",function(event) {
                    ...
                    app.client.request(undefined, '/front-end/check-result/get-student', 'GET', queryStringObject, undefined, function(statusCode, responsePayload){
                        if (statusCode !== 200) {
                            ...
                            if (states.classes.length > 0) {
                                ...
                                app.client.request(undefined,'/front-end/check-result/get-student-result-sessions', 'GET', queryStringObject, undefined, function(statusCode, responsePayload) {
                                   if (statusCode !== 200) {
                                       // Try to get the error from the api, or set a default error message
                                       var error = typeof(responsePayload.Error) == 'string' ? responsePayload.Error : 'An error has occurred, please try again';
                ...
                elements.resultCheckerSessionSelector.addEventListener("change", function(event) {
                    ...
                    if (states.student_id && states.class_id && states.session_id) {
                        ...
                        CheckResultView.showLoading();
                        app.client.request(undefined, '/front-end/check-result/get-student-result-terms', 'GET', queryStringObject, undefined, function(statusCode, responsePayload) {
                           if (statusCode !== 200) {
                               // Try to get the error from the api, or set a default error message
                               var error = typeof(responsePayload.Error) == 'string' ? responsePayload.Error : 'An error has occurred, please try again';
