...
class CreateStudentTermlySubjectPositions extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('student_termly_subject_positions');
    ...
    {
        $this->table('student_termly_subject_positions')->drop();
    }
}
