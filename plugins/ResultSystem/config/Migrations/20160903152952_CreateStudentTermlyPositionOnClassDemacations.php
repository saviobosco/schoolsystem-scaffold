...
class CreateStudentTermlyPositionOnClassDemacations extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('student_termly_position_on_class_demacations');
    ...
    {
        $this->table('student_termly_position_on_class_demacations')->drop();
    }
}
