...
$this->assign('title','All Students');
?>
<div class="row">
    <div class="col-sm-12">
    ...
    <?php foreach ($students as $student): ?>
        <tr>
            ...
            <td class="actions">
                ...
                <?= $this->Html->link(__('View'), ['action' => 'view',$student->id],['escape'=>false,'class'=>'btn btn-inverse btn-sm']) ?>
                <?= $this->Html->link(__('Add Fee'), ['controller'=>'StudentFees','action' => 'add',$student->id],['escape'=>false,'class'=>'btn btn-success btn-sm']) ?>
