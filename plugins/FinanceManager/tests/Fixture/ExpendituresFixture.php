...
class ExpendituresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'expenditures_ibfk_2' => ['type' => 'foreign', 'columns' => ['expenditure_category_id'], 'references' => ['expenditure_categories', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
            'expenditures_ibfk_3' => ['type' => 'foreign', 'columns' => ['expenditure_category_id'], 'references' => ['expenditure_categories', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
