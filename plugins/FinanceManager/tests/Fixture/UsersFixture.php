...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'first_name' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        'last_name' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        'token' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        'token_expires' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'api_token' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'role' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => 'user', 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        'record_id' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'record_id' => ['type' => 'index', 'columns' => ['record_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'token_expires' => '2018-02-17 12:59:32',
            'api_token' => 'Lorem ipsum dolor sit amet',
            'activation_date' => '2018-02-17 12:59:32',
            'tos_date' => '2018-02-17 12:59:32',
            'active' => 1,
            'is_superuser' => 1,
            'role' => 'Lorem ipsum dolor sit amet',
            'record_id' => 'Lorem ipsum dolor sit amet',
            'created' => '2018-02-17 12:59:32',
            'modified' => '2018-02-17 12:59:32'
        ],
    ];
}
