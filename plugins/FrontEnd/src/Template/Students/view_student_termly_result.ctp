...
<div class="container-fluid m-t-20">
    ...
    <div class="pull-right">
        <?= $this->Html->link('LogOut',['action'=>'destroySession'],['class'=>'btn btn-primary btn-sm']) ?>
    </div>
    ...
    <div class="alert alert-danger">
        <h2 class="text-center"> This Result has not yet been published  </h2>
    </div>
    <?php else : ?>
            ...
            <table class="table result-details-table ">
                ...
                <?php if (!empty( $studentPosition )): ?>
                    ...
                    <tr>
                        ...
                        <td><?php /* $this->Result->nextTermDate(@$nextTerm->start_date)*/ ?></td>
                    </tr>
                <?php endif; ?>
            </table>
        </div>
