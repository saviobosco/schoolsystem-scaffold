 ...
 *
 * @method \BankSystem\Model\Entity\CreditTransaction get($primaryKey, $options = [])
 * @method \BankSystem\Model\Entity\CreditTransaction newEntity($data = null, array $options = [])
 * @method \BankSystem\Model\Entity\CreditTransaction[] newEntities(array $data, array $options = [])
 * @method \BankSystem\Model\Entity\CreditTransaction|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \BankSystem\Model\Entity\CreditTransaction patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \BankSystem\Model\Entity\CreditTransaction[] patchEntities($entities, array $data, array $options = [])
 * @method \BankSystem\Model\Entity\CreditTransaction findOrCreate($search, callable $callback = null, $options = [])
 *
...
class CreditTransactionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('credit_transactions');
