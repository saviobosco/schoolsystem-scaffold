...
/**
 * StudentsAffectiveDispositionScore Entity
 *
 * @property int $id
 * @property string $student_id
 * @property int $affective_id
 * @property int $score
 ...
 * @property \SkillsGradingSystem\Model\Entity\Affective $affective
 ...
 */
class StudentsAffectiveDispositionScore extends Entity
{
