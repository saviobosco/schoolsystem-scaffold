<?php
echo $this->Site->css('jquery-jvectormap/jquery-jvectormap-1.2.2.css',['block'=>true]);
echo $this->Site->css('bootstrap-calendar/css/bootstrap_calendar.css',['block'=>true]);
echo $this->Site->css('gritter/css/jquery.gritter.css',['block'=>true]);
echo $this->Site->css('morris/morris.css',['block'=>true]);
?>
<div class="row">
    <!-- begin col-3 -->
...
<?php
echo $this->Site->script('morris/raphael.min.js',['block'=>true]);
echo $this->Site->script('morris/morris.js',['block'=>true]);
echo $this->Site->script('jquery-jvectormap/jquery-jvectormap-1.2.2.min.js',['block'=>true]);
echo $this->Site->script('jquery-jvectormap/jquery-jvectormap-world-merc-en.js',['block'=>true]);
echo $this->Site->script('bootstrap-calendar/js/bootstrap_calendar.min.js',['block'=>true]);
echo $this->Site->script('gritter/js/jquery.gritter.js',['block'=>true]);
echo $this->Html->script('dashboard-v2.js',['block'=>true]);
?>