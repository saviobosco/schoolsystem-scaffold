...
<div class="col-sm-12">
    <h3><?= __('Students') ?></h3> <?= $this->Html->link(' <i class="fa fa-plus-square-o"></i> '.__('Add New Admin'), ['action' => 'add'],['escape'=>false,'class'=>'btn btn-primary pull-right','title'=>'Add New Teacher']) ?>
